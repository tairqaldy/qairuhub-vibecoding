...
Sample responses are where tokens leak. Replace every key, cookie, phone number and email before the text goes near a prompt. What you paste now lives in a transcript, a log, and possibly a repo.
</Callout>
