...
const questions: Q[] = [
  {
    q: {
      en: 'In March 2025, Y Combinator said that for about a quarter of its Winter 2025 batch, what share of the codebase was generated by AI?',
      kk: '2025 жылдың наурызында Y Combinator өзінің Winter 2025 тобының шамамен төрттен бірінде кодтың қанша пайызын ЖИ жазғанын айтты?',
    },
    min: 0,
    max: 100,
    answer: 95,
    ...
    start: 50,
    fact: {
      en: 'YC managing partner Jared Friedman said a quarter of the W25 batch had 95% of their codebases generated by AI. The nuance usually dropped: these founders are highly technical and could write it themselves, and the figure excludes imported library code.',
      kk: 'YC басқарушы серіктесі Jared Friedman W25 тобының төрттен бірінде кодтың 95%-ын ЖИ жазғанын айтты. Әдетте айтылмай қалатын нюанс: бұл құрылтайшылар техникалық жағынан күшті, өздері де жаза алады, әрі бұл сан сырттан алынған кітапхана кодын қамтымайды.',
    },
    source: 'TechCrunch, 6 Mar 2025',
