...
export const ui = {
  en: {
    ...
    'site.description': 'A free interactive masterclass from QairuHub. Learn vibecoding hands-on, from your first prompt to a team of agents. English and Kazakh.',
    'nav.try': 'Try it',
    'nav.learn': 'Learn',
    'nav.labs': 'Labs',
    'nav.tools': 'Tools',
    ...
    'auth.required': 'Create a free account to continue',
    'auth.requiredBody': 'The course is free. An account saves your XP and your place.',
    'nav.menu': 'Menu',
    'nav.close': 'Close',
    ...
    'lesson.act': 'Act',
    'lesson.minutes': 'min',
    'lesson.objective': 'After this you can',
    ...
    'lesson.fallbackNotice': 'Not translated yet. Showing the English version.',
    ...
    'footer.madeBy': 'Built overnight by AI agents, directed by one human. That is the point.',
    'footer.community': 'A QairuHub project',
    'footer.rights': 'Free to use for learning and teaching.',
    'footer.sourceCode': 'Source code',
    'notFound.title': 'This page wandered off',
    'notFound.body': 'The agent could not find it either. Start from the beginning.',
    'level.1': 'Beginner',
  ...
  kk: {
    ...
    'site.description': 'QairuHub-тың тегін интерактивті мастер-класы. Vibecoding-ті тәжірибеде үйрен: алғашқы prompt-тан agent-тер командасына дейін. Қазақша және ағылшынша.',
    'nav.try': 'Байқап көр',
    'nav.learn': 'Оқу',
    'nav.labs': 'Практика',
    'nav.tools': 'Құралдар',
    ...
    'auth.signIn': 'Кіру',
    'auth.signUp': 'Аккаунт ашу',
    'auth.account': 'Аккаунт',
    'auth.signOut': 'Шығу',
    'auth.required': 'Жалғастыру үшін тегін аккаунт аш',
    'auth.requiredBody': 'Курс тегін. Аккаунт XP-ің мен қай жерде тоқтағаныңды сақтайды.',
    'nav.menu': 'Мәзір',
    'nav.close': 'Жабу',
    ...
    'lesson.act': 'Бөлім',
    'lesson.minutes': 'мин',
    'lesson.objective': 'Осыдан кейін сен істей аласың',
    'lesson.step': 'Цикл қадамы',
    'lesson.onThisPage': 'Осы бетте',
    'lesson.markComplete': 'Аяқтадым',
    ...
    'lesson.fallbackNotice': 'Бұл бет әлі аударылмаған. Ағылшынша нұсқасы тұр.',
    ...
    'progress.xp': 'XP',
    'progress.done': 'дайын',
    'progress.yourProgress': 'Прогресің',
    ...
    'footer.madeBy': 'Бұл сайтты ЖИ agent-тер бір түнде жасады, оларды адам басқарды. Мәні де сонда.',
    'footer.community': 'QairuHub жобасы',
    'footer.rights': 'Оқуға да, оқытуға да еркін пайдалан.',
    'footer.sourceCode': 'Бастапқы код',
    'notFound.title': 'Бұл бет адасып кетті',
    'notFound.body': 'Оны agent те таба алмады. Басынан бастап көр.',
    'level.1': 'Бастаушы',
    'level.2': 'Орта',
    'level.3': 'Жоғары',
  },
