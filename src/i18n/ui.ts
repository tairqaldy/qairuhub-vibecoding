...
export const ui = {
  en: {
    ...
    'auth.requiredBody': 'The course is free. An account saves your XP and your place in it.',
    'nav.menu': 'Menu',
    'nav.close': 'Close',
  ...
  kk: {
    ...
    'auth.requiredBody': 'Курс тегін. Аккаунт сенің XP-ің мен қай жерде тұрғаныңды сақтайды.',
    'nav.menu': 'Мәзір',
    'nav.close': 'Жабу',
